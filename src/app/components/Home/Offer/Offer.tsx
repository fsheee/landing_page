    ...
    <div className="flex items-center justify-center pt-24 pb-24 mb-20 bg-black">
      <div className="text-center px-6">
        ...
        <p className="text-gray-400 mb-8">
          Tell us your Apple ID email address so we can send you a TestFlight invitation directly
        </p>
        <button
          className="bg-blue-500 text-white py-3 px-8 rounded-full text-lg font-medium mb-4 hover:bg-blue-600 transition-all duration-300"
        >
