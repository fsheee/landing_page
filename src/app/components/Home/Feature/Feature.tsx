...
import { FaBook, FaCog, FaHeadset, FaInfinity, FaLaptop, FaLayerGroup, FaMobile, FaShieldAlt } from 'react-icons/fa';
  ...
  <div className="w-[80%] mx-auto text-center">
    ...
    <div className="grid mt-16 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
      {feature.map((feature, index) => (
        ...
        >
          <div
            className="text-3xl w-14 h-14 bg-gray-800 bg-opacity-10 flex items-center justify-center flex-col rounded-full"
          >
